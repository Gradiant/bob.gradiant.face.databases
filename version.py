...
def main():
    ...
    parser.add_argument('-umv', '--update-minor-version', dest='update_minor_version', action='store_true', help='update the minor version on git repository')
    parser.add_argument('-uv', '--update-version', dest='new_version', action='store', type=str, help='update the version on git repository')
